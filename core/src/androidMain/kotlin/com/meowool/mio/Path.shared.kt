...
import com.meowool.toolkit.sweekt.cast
import com.meowool.toolkit.sweekt.safeCast
import java.io.File
import java.net.URI
 ...
 */
actual inline fun Path(first: String, vararg more: String): Path = runCatching {
 ...
 * @see Paths.get
 */
inline fun Path(uri: URI): Path = runCatching {
 ...
 */
inline fun File.toMioPath(): Path = runCatching {
  toPath().toMioPath()
}.getOrElse {
  FilePath(this)
}
