...
fun String.wrapLine(columnLimit: Int = 95): String {
  val out = StringBuffer()
  LineWrapper(out, "", columnLimit).use {
    it.append(this)
  }
  return out.toString()
}
 ...
 * [LineWrapper.append], which will replace spaces with newlines where necessary.
 */
